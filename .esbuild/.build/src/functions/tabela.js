...
// src/functions/tabela.ts
var tabela_exports = {};
__export(tabela_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(tabela_exports);
...
var compileTemplate = async (data) => {
  ...
  const teste = (0, import_handlebars.compile)(html)(data);
  console.log(teste);
...
var handler = async (event) => {
  ...
  return {
    statusCode: 201,
    body: JSON.stringify({
      message: "Certificado criado com suscesso",
